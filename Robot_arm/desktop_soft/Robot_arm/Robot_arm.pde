...
public void sendCommands() {
  if (keyState[KeyEvent.VK_W]) comPort.write("w");
  if (keyState[KeyEvent.VK_S]) comPort.write("s");
  if (keyState[KeyEvent.VK_A]) comPort.write("a");
  if (keyState[KeyEvent.VK_D]) comPort.write("d");
  if (keyState[KeyEvent.VK_Q]) comPort.write("q");
  if (keyState[KeyEvent.VK_E]) comPort.write("e");
  if (keyState[KeyEvent.VK_I]) comPort.write("i");
  if (keyState[KeyEvent.VK_K]) comPort.write("k");
  if (keyState[KeyEvent.VK_J]) comPort.write("j");
  if (keyState[KeyEvent.VK_L]) comPort.write("l");
}
